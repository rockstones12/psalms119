...
const Psalm119Challenge = () => {
  return (
    <div className="flex flex-col items-center justify-center h-screen nig">
      <div className="text-center font-rowdies pt-9">
        <h1 className="text-5xl font-bold text-light">Psalm 119</h1>
        <h2 className="text-[50px] font-bold text-primary mt-4 leading-10">
          National Values Challenge.
        </h2>
      </div>
      <p className="text-lg max-w-5xl mt-8 text-center">
